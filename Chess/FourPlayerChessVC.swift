//
//  FourPlayerChessVC.swift
//  Chess
//
//  Created by Roselle Milvich on 10/16/16.
...
class FourPlayerChessVC: UIViewController, GamePresenterProtocol {
    ...
    func setupGame() {
        ...
        game = ChessGame(chessVariation: .fourPlayer, gameView: gameView)
